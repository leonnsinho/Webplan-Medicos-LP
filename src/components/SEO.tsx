...
const SEO: React.FC<SEOProps> = ({
  ...
  description = "Planos de saúde especiais para médicos com até 30% de desconto. Cobertura nacional, melhores operadoras: Amil, SulAmérica, NotreDame. Cotação online.",
