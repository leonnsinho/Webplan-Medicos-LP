      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 sm:py-16">
        <div className="grid md:grid-cols-3 gap-8 sm:gap-12">
            ...
            <div className="space-y-4">
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="text-blue-200">(11) 4116-5378</p>
                  <p className="text-blue-200">(11) 95930-5175</p>
                </div>
              </div>
              ...
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="text-blue-200">atendimento@segurosaudeweb.com</p>
                </div>
              </div>
          ...
          <div className="space-y-6">
            ...
            <div className="space-y-4">
              <div className="flex items-start gap-3">
                <Building className="text-blue-300 mt-1 flex-shrink-0" size={20} />
                <div>
                  <p className="font-medium">Razão Social</p>
                  <p className="text-blue-200"><span className="font-bold">Web</span><span className="font-light">Plan</span> Corretora de Seguros</p>
                </div>
              </div>
              
              <div>
                <p className="font-medium">CNPJ</p>
                <p className="text-blue-200">22.729.507/0001-13</p>
              </div>
              
              <div>
                <p className="font-medium">SUSEP</p>
                <p className="text-blue-200">202017143</p>
              </div>
            </div>
          </div>
          ...
          <div className="space-y-6">
            ...
            <div className="space-y-4">
              <p className="text-blue-200 leading-relaxed">
                Especialistas em planos de saúde para profissionais da enfermagem,
                oferecendo as melhores condições do mercado com atendimento personalizado.
              </p>
              
              <div className="space-y-2">
                <p className="font-medium">Horário de Atendimento</p>
                <p className="text-blue-200">Todos os dias de 8h às 20h</p>
              </div>
            </div>
          </div>
        </div>
