...
const HeroSection: React.FC = () => {
  ...
  return (
    <main>
      <section id="home" className="pt-20 sm:pt-16 bg-gradient-to-br from-blue-50 to-white overflow-hidden" itemScope itemType="https://schema.org/Service">
          ...
          <div className="grid lg:grid-cols-2 gap-8 lg:gap-12 items-center">
              ...
              <AnimatedSection delay={0.8} direction="up">
                <div className="flex flex-col sm:flex-row gap-4">
                  <motion.button
                    ...
                    className="bg-blue-600 hover:bg-blue-700 text-white px-8 py-4 rounded-lg font-semibold text-lg transition-all duration-200 transform hover:scale-105 shadow-lg hover:shadow-xl flex items-center justify-center gap-2"
            ...
            <AnimatedSection direction="right" delay={0.4} duration={1.0}>
              <div className="relative">
                ...
                <motion.div 
                  className="absolute top-6 left-6 w-full h-full bg-gradient-to-br from-blue-600 to-blue-800 rounded-2xl -z-10"
