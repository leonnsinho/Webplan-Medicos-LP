...
import { CheckCircle, Phone, MessageCircle, Users, Brain } from 'lucide-react';
...
const PsicologosPage: React.FC = () => {
  const handleWhatsAppClick = () => {
    const message = encodeURIComponent(
      'Olá! Sou psicólogo(a) e quero uma cotação personalizada de plano de saúde'
    );
  ...
  return (
    <>
      <SEO
        title="Planos de Saúde para Psicólogos CRP: Valores e Como Contratar 2025"
        description="Planos de saúde para psicólogos CRP: compare Amil, Hapvida, Ampla e SulAmérica. Valores 2025, rede credenciada, processo de contratação e como escolher o melhor plano."
      ...
      <div className="min-h-screen bg-gradient-to-br from-purple-50 to-violet-50">
        ...
        <section className="pt-40 pb-20 px-4 sm:px-6 lg:px-8">
          <div className="max-w-7xl mx-auto">
            <AnimatedSection direction="up">
              <div className="text-center mb-16">
                <h1 className="text-4xl sm:text-5xl lg:text-6xl font-bold text-gray-900 mb-8 leading-tight">
                  Planos de Saúde para <span className="text-purple-600">Psicólogos CRP</span>
                </h1>
                ...
                <div className="flex flex-col sm:flex-row items-center justify-center gap-4 mt-8">
                  <a
                    href="#formulario"
                    className="w-full sm:w-auto inline-flex items-center justify-center gap-2 bg-purple-600 text-white px-8 py-4 rounded-full text-lg font-semibold hover:bg-purple-700 transition-all duration-300 shadow-lg hover:shadow-xl transform hover:scale-105"
                  >
            ...
            <AnimatedSection direction="up" delay={0.2}>
              <div className="bg-gradient-to-r from-purple-50 to-violet-50 rounded-2xl p-8 border-l-4 border-purple-500 mb-12">
                <p className="text-lg text-purple-900 mb-4">
                  <strong>Planos de saúde para psicólogos CRP</strong> funcionam através de contratação coletiva por adesão, intermediada por associações profissionais. Psicólogos registrados no CRP-SP têm acesso a operadoras como Amil, Hapvida, Ampla e SulAmérica com valores até 40% menores que planos individuais.
                </p>
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <AnimatedSection direction="up">
              <h2 className="text-3xl sm:text-4xl font-bold text-gray-900 mb-8 text-center">
                Como Funcionam os Planos de Saúde para Psicólogos CRP
              </h2>
            </AnimatedSection>
            ...
            <div className="grid lg:grid-cols-2 gap-8 mb-12">
              <AnimatedSection direction="left">
                <div className="bg-purple-50 rounded-2xl p-8">
                  <h3 className="text-2xl font-bold text-gray-900 mb-4">CRP-SP: O que é e por que é necessário</h3>
                  <p className="text-gray-700 mb-4">
                    O CRP-SP (Conselho Regional de Psicologia de São Paulo) é o órgão regulador da profissão. Todo psicólogo precisa de registro ativo para atuar legalmente. O registro no CRP-SP é requisito para contratar planos de saúde por adesão da categoria.
                  </p>
                </div>
              </AnimatedSection>
            ...
            <AnimatedSection direction="up" delay={0.2}>
              <div className="bg-gradient-to-r from-purple-500 to-violet-500 text-white rounded-2xl p-8 text-center">
                <p className="text-lg">
                  <strong>Principal benefício:</strong> Ter acesso a planos de operadoras de bandeira renomada (Amil, Hapvida, Ampla, SulAmérica) através de entidade de classe, com valores mais acessíveis que planos individuais - que inclusive não existem mais para essas operadoras. Você mantém o plano mudando de emprego ou local de atendimento.
                </p>
              </div>
            </AnimatedSection>
          </div>
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <AnimatedSection direction="up">
              <h2 className="text-3xl sm:text-4xl font-bold text-gray-900 mb-12 text-center">
                Quem Pode Contratar Planos de Saúde para Psicólogos CRP
              </h2>
            </AnimatedSection>
              ...
              <AnimatedSection direction="left">
                <div className="bg-white rounded-2xl p-8 shadow-lg">
                  <h3 className="text-xl font-bold text-gray-900 mb-4 flex items-center gap-2">
                    ...
                    Profissionais elegíveis (registro ativo CRP-SP)
                  </h3>
                  <ul className="space-y-3">
                    {['Psicólogos clínicos', 'Psicólogos organizacionais', 'Psicólogos educacionais', 'Psicólogos sociais', 'Neuropsicólogos'].map((prof) => (
                  ...
                  <p className="text-gray-600 mt-4">
                    Não importa se trabalha em consultório próprio, clínica, hospital, empresa ou está desempregado. Precisa apenas de registro ativo no CRP-SP + associação à entidade através do nosso time.
                  </p>
                </div>
              </AnimatedSection>
                ...
                <div className="bg-white rounded-2xl p-8 shadow-lg">
                  ...
                  <div className="bg-yellow-50 border-l-4 border-yellow-500 p-4 rounded">
                    <p className="text-sm text-yellow-900">
                      <strong>Pais como dependentes:</strong> Apenas a <strong>Amil para Psicólogos CRP</strong> aceita pais como dependentes. Hapvida, Ampla e SulAmérica não aceitam pais nos planos por adesão.
                    </p>
                  </div>
                </div>
              </AnimatedSection>
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <AnimatedSection direction="up">
              <h2 className="text-3xl sm:text-4xl font-bold text-gray-900 mb-6 text-center">
                Operadoras de Planos de Saúde para Psicólogos CRP
              </h2>
              <p className="text-xl text-gray-600 text-center max-w-4xl mx-auto mb-12">
                Quatro operadoras principais oferecem planos para psicólogos em 2025. A diferença entre elas está na rede credenciada e modelo de atendimento.
              </p>
            </AnimatedSection>
            ...
            <div className="grid md:grid-cols-2 gap-8">
              ...
              <AnimatedSection direction="up" delay={0.1}>
                <div className="bg-gradient-to-br from-blue-50 to-blue-100 rounded-2xl p-8 shadow-lg hover:shadow-xl transition-all">
                  <h3 className="text-2xl font-bold text-blue-900 mb-4">1. Amil para Psicólogos CRP</h3>
          ...
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            <AnimatedSection direction="up">
              ...
              <p className="text-xl text-purple-100 mb-8">
                Nossa equipe especializada analisa seu perfil profissional, região de atendimento e orçamento para indicar o melhor plano. Atendemos psicólogos em São Paulo há mais de 10 anos.
              </p>
              <button
                onClick={handleWhatsAppClick}
            ...
            <div className="space-y-8">
              ...
              <AnimatedSection direction="left">
                <div className="bg-gradient-to-r from-yellow-50 to-orange-50 rounded-2xl p-8">
                  ...
                  <p className="text-gray-700">
                    A partir dos 44 anos, os reajustes ficam pesados. Se tem MEI (comum entre psicólogos autônomos), planos empresariais PME saem muito mais baratos. Operadoras como Sami oferecem planos a partir de R$ 112/mês para MEI.
                  </p>
                </div>
              </AnimatedSection>
            </div>
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
              {[
                {
                  step: '1',
                  title: 'Confirme seu registro CRP-SP',
                ...
                },
                {
                  ...
                  description: 'RG, CPF, comprovante de residência, carteira CRP-SP. Para dependentes: certidões e documentos pessoais.'
                },
                {
                  step: '5',
                    ...
                    <tbody className="divide-y divide-gray-200">
                      {[
                        ...
                        <tr key={index} className="hover:bg-gray-50">
                          ...
                          <td className="px-6 py-4 font-semibold text-purple-600">{prazo}</td>
                        </tr>
                      ))}
                    </tbody>
                  </table>
        ...
        <section className="py-20 bg-gradient-to-r from-purple-600 to-violet-600">
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            <AnimatedSection direction="up">
              <h2 className="text-3xl sm:text-4xl font-bold text-white mb-6">
                Tire Suas Dúvidas com Quem Entende de Planos para Psicólogos
              </h2>
              <p className="text-xl text-purple-100 mb-8">
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center">
                ...
                <a
                  ...
                  className="bg-white hover:bg-gray-100 text-purple-600 px-8 py-4 rounded-xl font-semibold text-lg transition-all duration-300 transform hover:scale-105 shadow-lg hover:shadow-xl flex items-center justify-center gap-2"
                >
                  <Phone size={24} />
                  (11) 4116-5378
                </a>
        ...
        <section className="py-20 bg-white">
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
            <AnimatedSection direction="up">
              <h2 className="text-3xl sm:text-4xl font-bold text-gray-900 mb-8 text-center">
                Resumo: Planos de Saúde para Psicólogos CRP-SP
              </h2>
            </AnimatedSection>
            ...
            <AnimatedSection direction="up" delay={0.2}>
              <div className="bg-gradient-to-r from-purple-50 to-violet-50 rounded-2xl p-8 mb-8">
                ...
                <ul className="space-y-3">
                  {[
                    'Planos de saúde para psicólogos CRP dão acesso a operadoras de bandeira renomada através de entidades de classe',
                    ...
                    'Amil para Psicólogos CRP aceita pais como dependentes (única)',
                    ...
                    'Psicólogos com MEI podem economizar 40% com planos PME',
