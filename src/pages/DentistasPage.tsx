...
const DentistasPage: React.FC = () => {
  ...
  const structuredData = {
    ...
    "@type": "Service",
    "name": "Planos de Saúde para Dentistas CRO",
    "description": "Planos de saúde exclusivos para cirurgiões-dentistas registrados no CRO-SP com valores até 40% menores",
    "provider": {
      "@type": "Organization",
