...
import { CheckCircle, Phone, MessageCircle, Users, Heart } from 'lucide-react';
import AnimatedSection from '../components/AnimatedSection';
import ContactForm from '../components/ContactForm';
import SEO from '../components/SEO';

const EnfermeirosPage: React.FC = () => {
  const handleWhatsAppClick = () => {
    const message = encodeURIComponent(
      'Olá! Sou enfermeiro(a) e quero uma cotação personalizada de plano de saúde'
    );
  ...
  return (
    <>
      <SEO 
        title="Planos de Saúde para Enfermeiros COREN: Valores e Como Contratar 2025"
        description="Planos de saúde para enfermeiros COREN: compare Amil, Hapvida, Ampla e SulAmérica. Valores 2025, rede credenciada, processo de contratação e como escolher o melhor plano."
        keywords="planos de saude para enfermeiros coren, plano saúde coren sp, enfermeiro plano saúde, coren plano saúde, plano saúde técnico enfermagem"
        canonicalUrl="https://simuleplanodesaude.com/planos-de-saude-para-enfermeiros"
      />
      ...
      <div className="min-h-screen bg-gradient-to-br from-teal-50 to-blue-50">
        ...
        <section className="pt-40 pb-20 px-4 sm:px-6 lg:px-8">
          <div className="max-w-7xl mx-auto">
            <AnimatedSection direction="up">
              <div className="text-center mb-16">
                <h1 className="text-4xl sm:text-5xl lg:text-6xl font-bold text-gray-900 mb-8 leading-tight">
                  Planos de Saúde para <span className="text-teal-600">Enfermeiros COREN</span>
                </h1>
                ...
                <div className="flex flex-col sm:flex-row items-center justify-center gap-4 mt-8">
                  <a
                    href="#formulario"
                    className="w-full sm:w-auto inline-flex items-center justify-center gap-2 bg-teal-600 text-white px-8 py-4 rounded-full text-lg font-semibold hover:bg-teal-700 transition-all duration-300 shadow-lg hover:shadow-xl transform hover:scale-105"
                  >
            ...
            <AnimatedSection direction="up" delay={0.2}>
              <div className="bg-gradient-to-r from-blue-50 to-cyan-50 rounded-2xl p-8 border-l-4 border-blue-500 mb-12">
                <p className="text-lg text-blue-900 mb-4">
                  <strong>Planos de saúde para enfermeiros COREN</strong> funcionam através de contratação coletiva por adesão, intermediada por associações profissionais. Enfermeiros, técnicos e auxiliares de enfermagem registrados no COREN-SP têm acesso a operadoras como Amil, Hapvida, Ampla e SulAmérica com valores até 40% menores que planos individuais.
                </p>
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <AnimatedSection direction="up">
              <h2 className="text-3xl sm:text-4xl font-bold text-gray-900 mb-8 text-center">
                Como Funcionam os Planos de Saúde para Enfermeiros COREN
              </h2>
            </AnimatedSection>
            ...
            <div className="grid lg:grid-cols-2 gap-8 mb-12">
              <AnimatedSection direction="left">
                <div className="bg-teal-50 rounded-2xl p-8">
                  <h3 className="text-2xl font-bold text-gray-900 mb-4">COREN-SP: O que é e por que é necessário</h3>
                  <p className="text-gray-700 mb-4">
                    O COREN-SP (Conselho Regional de Enfermagem de São Paulo) é o órgão regulador da profissão. Todo enfermeiro, técnico ou auxiliar precisa de registro ativo para trabalhar legalmente. O registro no COREN-SP é requisito para contratar planos de saúde por adesão da categoria.
                  </p>
                </div>
              </AnimatedSection>
            ...
            <AnimatedSection direction="up" delay={0.2}>
              <div className="bg-gradient-to-r from-blue-500 to-teal-500 text-white rounded-2xl p-8 text-center">
                <p className="text-lg">
                  <strong>Principal benefício:</strong> Ter acesso a planos de operadoras de bandeira renomada (Amil, Hapvida, Ampla, SulAmérica) através de entidade de classe, com valores mais acessíveis que planos individuais - que inclusive não existem mais para essas operadoras. Você mantém o plano mudando de emprego.
                </p>
              </div>
            </AnimatedSection>
          </div>
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <AnimatedSection direction="up">
              <h2 className="text-3xl sm:text-4xl font-bold text-gray-900 mb-12 text-center">
                Quem Pode Contratar Planos de Saúde para Enfermeiros COREN
              </h2>
            </AnimatedSection>
              ...
              <AnimatedSection direction="left">
                <div className="bg-white rounded-2xl p-8 shadow-lg">
                  <h3 className="text-xl font-bold text-gray-900 mb-4 flex items-center gap-2">
                    ...
                    Profissionais elegíveis (registro ativo COREN-SP)
                  </h3>
                  <ul className="space-y-3">
                    {['Enfermeiros', 'Técnicos de enfermagem', 'Auxiliares de enfermagem', 'Obstetrizes'].map((prof) => (
                  ...
                  <p className="text-gray-600 mt-4">
                    Não importa se trabalha em hospital público/privado, clínica, home care ou está desempregado. Precisa apenas de registro ativo no COREN-SP + associação à entidade através do nosso time.
                  </p>
                </div>
              </AnimatedSection>
                ...
                <div className="bg-white rounded-2xl p-8 shadow-lg">
                  ...
                  <div className="bg-yellow-50 border-l-4 border-yellow-500 p-4 rounded">
                    <p className="text-sm text-yellow-900">
                      <strong>Pais como dependentes:</strong> Apenas a <strong>Amil para Enfermeiros COREN</strong> aceita pais como dependentes. Hapvida, Ampla e SulAmérica não aceitam pais nos planos por adesão.
                    </p>
                  </div>
                </div>
              </AnimatedSection>
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <AnimatedSection direction="up">
              <h2 className="text-3xl sm:text-4xl font-bold text-gray-900 mb-6 text-center">
                Operadoras de Planos de Saúde para Enfermeiros COREN
              </h2>
              <p className="text-xl text-gray-600 text-center max-w-4xl mx-auto mb-12">
                Quatro operadoras principais oferecem planos para enfermeiros em 2025. A diferença entre elas está na rede credenciada e modelo de atendimento.
              </p>
            </AnimatedSection>
            ...
            <div className="grid md:grid-cols-2 gap-8">
              ...
              <AnimatedSection direction="up" delay={0.1}>
                <div className="bg-gradient-to-br from-blue-50 to-blue-100 rounded-2xl p-8 shadow-lg hover:shadow-xl transition-all">
                  <h3 className="text-2xl font-bold text-blue-900 mb-4">1. Amil para Enfermeiros COREN</h3>
            ...
            <AnimatedSection direction="up" delay={0.5}>
              <div className="mt-8 bg-green-50 border-l-4 border-green-500 p-6 rounded">
                <p className="text-green-900">
                  <strong>💡 Dica:</strong> Verifique quais hospitais próximos da sua casa e trabalho atendem em cada operadora antes de decidir. Nossa equipe pode te ajudar nessa análise.
                </p>
              </div>
            </AnimatedSection>
          </div>
          ...
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            <AnimatedSection direction="up">
              ...
              <p className="text-xl text-blue-100 mb-8">
                Nossa equipe especializada analisa seu perfil profissional, região de atendimento e orçamento para indicar o melhor plano. Atendemos enfermeiros em São Paulo há mais de 10 anos.
              </p>
              <button
                onClick={handleWhatsAppClick}
            ...
            <div className="space-y-8">
              ...
              <AnimatedSection direction="left">
                <div className="bg-gradient-to-r from-yellow-50 to-orange-50 rounded-2xl p-8">
                  ...
                  <p className="text-gray-700">
                    A partir dos 44 anos, os reajustes ficam pesados. Se tem MEI, planos empresariais PME saem muito mais baratos. Operadoras como Sami oferecem planos a partir de R$ 112/mês para MEI.
                  </p>
                </div>
              </AnimatedSection>
            </div>
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
              {[
                {
                  step: '1',
                  title: 'Confirme seu registro COREN-SP',
                ...
                },
                {
                  ...
                  description: 'RG, CPF, comprovante de residência, carteira COREN-SP. Para dependentes: certidões e documentos pessoais.'
                },
                {
                  step: '5',
                    ...
                    <tbody className="divide-y divide-gray-200">
                      {[
                        ...
                        <tr key={index} className="hover:bg-gray-50">
                          ...
                          <td className="px-6 py-4 font-semibold text-teal-600">{prazo}</td>
                        </tr>
                      ))}
                    </tbody>
                  </table>
        ...
        <section className="py-20 bg-gradient-to-r from-blue-600 to-teal-600">
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            <AnimatedSection direction="up">
              <h2 className="text-3xl sm:text-4xl font-bold text-white mb-6">
                Tire Suas Dúvidas com Quem Entende de Planos para Enfermeiros
              </h2>
              <p className="text-xl text-blue-100 mb-8">
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center">
                ...
                <a
                  ...
                  className="bg-white hover:bg-gray-100 text-teal-600 px-8 py-4 rounded-xl font-semibold text-lg transition-all duration-300 transform hover:scale-105 shadow-lg hover:shadow-xl flex items-center justify-center gap-2"
                >
                  <Phone size={24} />
                  (11) 4116-5378
                </a>
        ...
        <section className="py-20 bg-white">
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
            <AnimatedSection direction="up">
              <h2 className="text-3xl sm:text-4xl font-bold text-gray-900 mb-8 text-center">
                Resumo: Planos de Saúde para Enfermeiros COREN-SP
              </h2>
            </AnimatedSection>
            ...
            <AnimatedSection direction="up" delay={0.2}>
              <div className="bg-gradient-to-r from-teal-50 to-blue-50 rounded-2xl p-8 mb-8">
                ...
                <ul className="space-y-3">
                  {[
                    'Planos de saúde para enfermeiros COREN dão acesso a operadoras de bandeira renomada através de entidades de classe',
                    'Essas operadoras não comercializam mais planos individuais - a adesão por entidade é a forma de acesso',
                    'Não depende de vínculo empregatício (funciona mesmo desempregado)',
                    'Amil para Enfermeiros COREN aceita pais como dependentes (única)',
                    ...
                    'Enfermeiros com MEI podem economizar 40% com planos PME',
            ...
            <AnimatedSection direction="up" delay={0.3}>
              <div className="bg-gradient-to-r from-blue-50 to-cyan-50 rounded-2xl p-8">
                ...
                <ol className="space-y-3">
                  {[
                    'Liste hospitais próximos de casa e trabalho',
                    ...
                    <li key={index} className="flex items-start gap-3 text-gray-700">
                      <span className="font-bold text-teal-600 text-lg">{index + 1}.</span>
                      <span>{item}</span>
                    </li>
                  ))}
                </ol>
...
export default EnfermeirosPage;
